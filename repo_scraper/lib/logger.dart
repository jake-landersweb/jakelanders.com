...
void createFile() {
  String filename =
      '${Platform.environment["LOGGERPATH"]}${utils.getIsoDate()}.txt';
  File(filename).createSync(recursive: true);
  _loggerFile = File(filename);
  String val =
      "${utils.getIsoDate()} | STARTING SERVER FOR HOST: ${Platform.environment['APIHOST']!} PORT: ${Platform.environment['APIPORT']!}'\n";
